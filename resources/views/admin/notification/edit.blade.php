...
@section('title', 'Изменить уведомление')
@section('content')
        ...
        <form action="{{ route('admin.notifications.update',$notification['id']) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" value="{{$notification['title']}}" id="exampleInputEmail1" placeholder="Распродажа!">
                </div>

                <div class="form-group">
                    <label>Текст уведомления</label>
                    <textarea class="form-control" name="text" rows="3" placeholder="Текст ...">{{$notification['text']}}</textarea>
                </div>
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input class="custom-control-input" name="all_users" @if($notification['all_users']) checked @endif type="checkbox" id="customCheckbox1" value="option1">
