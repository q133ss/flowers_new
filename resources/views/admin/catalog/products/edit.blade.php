...
@section('content')
    ...
    @endif
    <form action="{{route('admin.products.update', $product['id'])}}" id="form-edit" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-group">
            <label>Название</label>
            <input type="text" name="title" value="{{$product['name']}}" class="form-control" placeholder="Товар 1">
        </div>
        <div class="form-group">
            <label>Описание</label>
            <textarea name="description" id="" class="form-control" cols="30" rows="10">{{$product['descr']}}</textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label>Цена</label>
            <input type="text" name="price" value="{{$product['price']}}" class="form-control" placeholder="1231">
        </div>

        <div class="form-group">
            <label>Баллы</label>
            <input type="text" name="score" value="{{$product['score']}}" class="form-control" placeholder="15">
        </div>

        <div class="form-group">
            <label>Скидка %</label>
            <input type="text" name="sale" value="{{$product['sale']}}" class="form-control" placeholder="20">
        </div>
