...
@section('content')
    <div class="card-body p-0">
        ...
        <table class="table table-sm">
            ...
            <tr>
                ...
                <td>
                    <form action="{{route('admin.catalog.tags.delete', $tag['id'])}}" method="POST">
                        @csrf
        ...
        <div class="modal" id="edit-modal{{$tag['id']}}" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{route('admin.catalog.tags.edit', $tag['id'])}}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal" id="create-modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{route('admin.catalog.tags.create', $tag['id'])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
