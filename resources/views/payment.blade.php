        ...
        <div class="containers">
            <div class="contact-content__block">
                ...
                <div class="dnew-message__block-list-text">
                    <br><br>
                    Оплата товара производится только с помощью банковской карты. Для этого, вам необходимо, на соответствующей странице нажать кнопку Оплата заказа банковской картой. Оплата происходит через ПАО СБЕРБАНК с использованием банковских карт следующих платёжных систем:
                    <br><br>
                    <ul>
                    <li>МИР</li>
