                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content header-profile__event-table-calendar-model">
                            ...
                            <div class="header-profile__event-table-calendar-model-content">
                                <form action="{ {route('account.event.create')}}" method="POST">
                                    @csrf
                        ...
                        <div class="modal-content header-profile__event-table-calendar-model">
                            ...
                            <div class="header-profile__event-table-calendar-model-content">
                                ...
                                <div class="model-header__registration-birthday">
                                    <input placeholder="12/02/1998" type="text" class="model-header__registration-birthday-input hasDa" id="datepicker">
                                ...
                                <button class="header-profile__event-table-calendar-model-btn" onclick="dob_update()"><a>Изменить</a></button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content header-profile__event-table-calendar-model">
                                ...
                                <div class="header-profile__event-table-calendar-model-content">
                                    ...
                                    <form action="{{route('account.event.edit', $event['id'])}}" method="POST">
                                        @csrf
                                        <div class="header-profile__event-table-calendar-model-title">Ваше событие</div>
